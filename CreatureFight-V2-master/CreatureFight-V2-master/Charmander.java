...
public class Charmander extends Creature
{
    ...
    /**
     * attack is a method that stores a reference to the CreatureWorld, initialize enemy to player two's creature, initialize enemyType to enemy type,
     * and if the player one has used an attack, remove health from player two and set the turn to two.
     * 
     * @param a int oarameter names idx that represent which attack is being

...
public class CreatureWorld extends World
{
    ...
    /**
     * getTurnNumber is a method that returns the turn number
     * 
    ...
    /**
     * setTurnNumber is a method that sets the turn number variable to the turn parameter
     * 
     * @param an integer parameter called turn that represent the number of turns

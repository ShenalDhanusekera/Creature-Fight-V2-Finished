...
public class Pikachu extends Creature
{
    ...
    /**
     * attack is a method that stores a reference to the CreatureWorld, initialize enemy to player one's creature, initialize enemyType to enemy type,
     * and if the player two has used an attack, remove health from player one and set the turn to one.
     * 
